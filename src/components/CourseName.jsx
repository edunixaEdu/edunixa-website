  ...
  return (
    <div className="w-full">
      <div className="mx-5 lg:mx-20 flex h-80 flex-col justify-center rounded bg-blue-600 px-5 lg:px-16">
        ...
        <div className="lg:my-8 text-xl text-white">{data.subHeading}</div>
        <div className="flex lg:w-1/3 py-10 lg:py-0 gap-5 lg:gap-0 lg:justify-between">
          <div className="flex">
            ...
            <div className="mx-2 text-white">{data.enrollNumber}Enrolled</div>
          </div>
          <div className="flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="mx-2 text-white">{data.rating}/5</div>
          </div>
        </div>
      </div>
    </div>
