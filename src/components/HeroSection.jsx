...
const HeroSection = () => {
  return (
    <div className="flex h-full w-full justify-center py-5 lg:p-20 rounded-lg p-4">
      <div className="flex h-full w-full flex-col items-center justify-evenly rounded-lg border bg-PrimeOne shadow md:flex-row">
        <img
